...
const Register = () => {
  ...
  if (checkBtn.current.context._errors.length === 0 && password === confirmpassword) {
      ...
      register({ first_name, last_name, email, phone_number, password }, dispatch)
        .then(() => {
          navigate("/success");
  ...
  return (
    <div
      className='login'
      style={{
        backgroundImage: `url(https://images.pexels.com/photos/7991319/pexels-photo-7991319.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)`,
      }}
    >
