...
//     const { user:currentUser, dispatch } = useContext(AuthContext)
    ...
    : `-${formated(duration - currentTime)}`;
    const totalDuration = formated(duration)
>>>>>>> b6584dddff47fa1f06d047fc5467496cd673128f
                ...
                <div className="timeline-posts">
                    ...
                    >
                        <div className="post-imag-e">
                                <>
                                <div className="imagey-user">
                                <img src={post?.user?.avatar ||"./676-6764065_default-profile-picture-transparent-hd-png-download.png"} alt="" className="imagey-image" />
