                    ...
                    <>
                      <div className='imagey-user'>
                        <img
                          ...
                          alt=''
                          className='imagey-image'
                        />
                        <span className='imagey-words'>
                ...
                <div className='post-container'>
                  ...
                  <div className='post-imag-e'>
                    <>
                      <div className='imagey-user'>
                        <img
                          src={post?.user?.avatar || './676-6764065_default-profile-picture-transparent-hd-png-download.png'}
                          alt=''
                          className='imagey-image'
                        />
                        <span className='imagey-words'>{post?.user?.first_name}</span>
                      </div>
                      <PlayArrowIcon
                        style={{
                          position: 'absolute',
                  ...
                  <p className='v-caption'>{post?.user?.first_name}: {post?.description}</p>
                  </div>
                </div>
              </div>
            )
