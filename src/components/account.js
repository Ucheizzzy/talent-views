...
const Account = () => {
  ...
  return (
    <>
      <Navbar />
      {show && <ProfileModal closeModal={setShow} show={show} />}
      <div className="account-head">
        <div className="account-body">
          <div className="user-notice">
            <div className="me-img-container-s  modImage">
              <div className="image-caption-s">
                <img
                  ...
                  src={account?.avatar || "../stockphoto.jpeg"}
                  alt=""
                  cache={false}
                />
                <input
            ...
            <span className="account">Hello {account?.first_name}</span>
            <span className="joined">Joined {date(account?.created_at)}</span>
        ...
        <div className="user-information">
          ...
          <span className="use-r billing">
            email: <b>{account?.email}</b>
          </span>
          <span className="use-r billing">
            phone: <b>{account?.phone_number}</b>
          </span>
          <hr />
            ...
            <div className="seasons" onClick={() => setName(true)}>
              {name ? (
                <input
                  ...
                  id=""
                  placeholder={
                    "Change username from " + account?.first_name + " ?"
                  }
                  className="mod-input"
            ...
            <div className="seasons" onClick={() => setNumber(true)}>
              {number ? (
                <input
                  ...
                  id=""
                  placeholder={
                    "Change number from " + account?.phone_number + " ?"
                  }
                  className="mod-input"
                  onChange={handleChange}
                />
          ...
          <hr />
          <span className="user-action" onClick={() => setShow(true)}>
            Change Password
          </span>
          <hr />
